...
<div class="card-block">
    ...
    <div class="caption">
        ...
        <p>
            <form action="{{ route('basket-add-main-full', $product) }}" method="POST">
                <button type="submit" class="btn card-btn" role="button">@lang('main.add_to_basket')</button>
                <a href="{{ route('product_fulls', [isset($category) ? $category->code : $product->category->code, $product->code]) }}" class="btn btn-default"
