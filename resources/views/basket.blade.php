        ...
        <table class="table table-striped">
            ...
            ?>
                ...
                <tr class="nth<?php echo $i ?>">
                    ...
                    <td><span class="l-price">{{ $product->price }}</span> руб.</td>
                    <td><span class="l-fullprice">0</span> руб.</td>
                    <script>
                    function pricer<?php echo $i ?>() {
                        var badge = $('tr.nth<?php echo $i ?> .badge').html();
                        var price = $('tr.nth<?php echo $i ?> .l-price').html();
                        $('tr.nth<?php echo $i ?> .l-fullprice').html(Number(price) * Number(badge));
            ...
            <tr>
                ...
                <td><span class="fullend">0</span> руб.</td>
            </tr>
            </tbody>
            @endisset
        </table>
